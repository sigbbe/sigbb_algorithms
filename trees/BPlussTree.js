...
const data = new Array(9, 17, 4, 21, 25, 26, 8, 10, 30, 22, 32);


console.log(`Data = [${data}]`)

let bPlussTree = new tree();

data.forEach(function (key, index) {
   bPlussTree.insert(key, index);
});


console.log(`Tree: ${bPlussTree.recnum}`)

bPlussTree.seek(data[4], true);

console.log(`Tree: ${bPlussTree.root.keyval}`)
